...
<body>
  ...
  <div class="card-body">
  <img src="<?php echo base_url('style/img/Taufik.jpeg');?>" class="rounded mx-auto d-block" alt="...">
    <h5 class="card-title">Taufik Masrizal</h5>
    <cite class="card-text">Belajarkuy adalah portal web untuk anak - anak indonesia mencari buku dan membaca buku dengan gratis. So jangan pernah berhenti untuk belajar dan mencoba hal baru, karna dari situlah kita bisa meningkatkan skill kita</cite>
  </div>
  ...
  <li class="media">
    <img class="mr-3" src="<?php echo base_url('style/img/anthony.jpg');?>" alt="Generic placeholder image">
    <div class="media-body">
      <h5 class="mt-0 mb-1">Anthony J. D'Angelo</h5>
      “Develop a passion for learning. If you do, you will never cease to grow.”
    </div>
  </li>
  <li class="media my-4">
    <img class="mr-3" src="<?php echo base_url('style/img/christine.jpg');?>" alt="Generic placeholder image">
    <div class="media-body">
      <h5 class="mt-0 mb-1">Christine Gregoire</h5>
      “Education is the foundation upon which we build our future.”
    </div>
  </li>
  <li class="media">
    <img class="mr-3" src="<?php echo base_url('style/img/habibie.jpg');?>" alt="Generic placeholder image">
    <div class="media-body">
      <h5 class="mt-0 mb-1">B.J Habibie</h5>
      "Masa depan Indonesia ditentukan oleh keunggulan sumber daya manusia Indonesia yang memiliki nilai budaya, memahami dan menguasai mekanisme pengembangan serta penerapan ilmu pengetahuan dan teknologi."
    </div>
  </li>
</ul>
            </div>
