          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Tabel Ebook Belajarkuy</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form class="form-inline my-2 my-lg-0" action="<?php echo site_url('belajar/search_admin');?>" method = "post">
            ...
            if($this->uri->segment(3)){
                ...
                foreach ($query as $list)
                {
                  ...
                  <tr>
                    ...
                    <td><?php echo anchor('belajar/hapus/'.$list->id_buku,'Hapus'); ?>	</td>
                  </tr>
                  <?php } ?>
                  </tbody>
                  
                </table>
                <div class="halaman">Hal :<?php echo $halaman;?></div>
              </div>
              <!-- /.card-body -->
            </div>
